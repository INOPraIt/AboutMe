    ...
    <Container>
      ...
      <Box display={{ md: 'flex' }}>
        <Box flexGrow={1} mb={5}>
          ...
          <p>
            Fullstack Web&Mobile разработчик | Опыт коммерческой разработки 3+ года | Node.js / React / React-native
          </p>
        </Box>
      </Box>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          Я fullstack разработчик, увлеченный созданием различных интернет площадок и мобильных приложений.
